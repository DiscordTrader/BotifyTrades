...
# ============================================================
# BotifyTrades - Linux EXE Build Specification
...
DIST_DIR = os.path.join(PROJECT_ROOT, 'packaging', 'linux', 'dist')
WORK_DIR = os.path.join(PROJECT_ROOT, 'packaging', 'linux', 'build_temp')
