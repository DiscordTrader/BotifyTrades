...
def generate_machine_bound_license(customer_id: str, machine_id: str, days: int) -> tuple:
    """
    ...
    Returns:
        Tuple of (license_key, expires_dt)
    """
...
Examples:
  ...
  python -m license.tools.generate_secure --customer trial_user --machine xyz789abc0123456 --days 7
...
They can get it by running: python -c "from src.machine_fingerprint import get_machine_id; print(get_machine_id())"
    ...
    print()
    print("=" * 80)
    print("MACHINE-BOUND LICENSE GENERATOR")
    print("=" * 80)
    ...
    if args.batch:
        ...
        for i in range(1, args.batch + 1):
            ...
            license_key, expires_dt = generate_machine_bound_license(customer_id, args.machine, args.days)
        ...
        license_key, expires_dt = generate_machine_bound_license(args.customer, args.machine, args.days)
        ...
        print()
        print("IMPORTANT: This license will ONLY work on the specified machine!")
