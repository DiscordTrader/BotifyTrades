...
**Telegram Integration** supports reading trading signals from Telegram groups/channels using a Telethon user client. It features a cross-thread architecture, unified signal processing with Discord, GUI management of Telegram settings, session persistence, and channel-aware routing for independent risk settings and broker selection.
