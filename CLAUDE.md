# BotifyTrades v9.3.3 — Project Context
...
| `upgrade/version.py` | ~160 | Version: APP_VERSION = "9.3.3" |

## Release Process
```bash
./scripts/release.sh admin 9.3.3   # Private admin build
./scripts/release.sh user 9.3.3    # Public hardened build
```
